...
depends: [["provide", "aipo.widget.ToolTip"],
["require", "dijit.Tooltip"]],
defineResource: function(dojo){if(!dojo._hasResource["aipo.widget.ToolTip"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
