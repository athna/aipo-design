...
depends: [["provide", "dojox.flash._common"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.flash._common"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
